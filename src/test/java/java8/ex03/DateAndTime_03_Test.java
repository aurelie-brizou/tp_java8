...
public class DateAndTime_03_Test {
	...
	public void test_localTime_of() {
		...
		// crée un objet LocalTime à l'heure 15h24m02s
	...
	public void test_localTime_parse() {
		...
		// crée un objet LocalTime à l'heure 09h30m00s à l'aide de la méthode parse
	...
	public void test_localTime_format() {
		...
		// crée un objet localTime à l'heure 12h00m00s
