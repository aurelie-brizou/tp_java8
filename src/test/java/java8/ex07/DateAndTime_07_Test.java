...
public class DateAndTime_07_Test {
	...
	public void test_date_to_localdate() throws Exception {
		...
		// crée une date Java 1 (12/02/2017)
		Date date = new Date(117, 1, 12);

		// transforme la date en Instant
		Instant now = date.toInstant();

		// transforme la date en LocalDate        
		LocalDate result =  LocalDateTime.ofInstant(now, ZoneId.systemDefault()).toLocalDate();
