...
public class DateAndTime_02_Test {
	...
	public void test_localDate_of() {
		...
		// crée un objet LocalDate à la date 24/12/2050
	...
	public void test_localDate_parse() {
		...
		// crée un objet LocalDate à la date 10/01/1990
	...
	public void test_localDate_format() {
		...
		// crée un objet LocalDate à la date 11/03/2015
		// utilise la méthode of
		LocalDate localDate = LocalDate.of(2015, 3, 11);

		// formatte la date pour que le test soit passant
	...
	public void test_localDate_format_with_hour() {
		...
		// Formatte la date pour avoir l'affichage suivant : "11/03/2015 00:00:00"
	...
	public void test_with() {
		...
		// crée un objet LocalDate à la date 10/01/2000
		// utilise la méthode of
